...
<div ng-show="$ctrl.currentGame != null">
	...
	<div class="row">
		<div class="col-lg-12 col-md-12">
			<div ng-repeat="sector in $ctrl.seatList" id="sector.id" class="col-lg-3 col-md-3 col-md-offset-2 col-lg-offset-2" ng-if="sector.id == 9 || sector.id == 10">
				<sector-asc></sector-asc>
			</div>
		</div>
	</div>
