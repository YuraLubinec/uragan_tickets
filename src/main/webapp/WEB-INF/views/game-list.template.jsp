      ...
      <div class="modal-body">
        ...
        <div class="container-fluid">
          ...
          <form ng-submit="$ctrl.submit()" name="myForm" id="" class="form-group" role="">
            ...
            <div class="form-group">
              <select class="form-control" ng-model="$ctrl.game.season_id" ng-options="season.id as season.years for season in $ctrl.seasonList"
                required="required">
            ...
            <div class="form-group">
              <div class="btn-group btn-group-justified">
                <a class="btn btn-success" ng-click="$ctrl.submit()" ng-disabled="myForm.$invalid">{{!$ctrl.game.id ? 'Створити' : 'Оновити'}}</a>
                <a class="btn btn-default" ng-click="$ctrl.reset()" class="btn btn-warning" ng-disabled="myForm.$pristine">Очистити форму</a>
              </div>
            </div>
          </form>
...
<div class="col-lg-2 col-md-2 add-padding-top  add-padding-left">
  <button id="idGameModal" data-toggle="modal" data-target="#myModal" class="btn btn-primary custom-width form-control" ng-click="$ctrl.reset()">Створити нову гру</button>
</div>
