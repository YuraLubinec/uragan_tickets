angular.module('subscriptionPage').component('subscriptionPage', {
  ...
  controller: ['$scope','SubscriptionPageService', function SubscriptionPageController($scope,SubscriptionPageService){
    var main = this;
    main.subscription = {id:null, fullName:'', seat_id:'', season_id:''};
    ...
    function fetchAllSubscription(){
    	...
    	SubscriptionPageService.fetchAllSubscription()
            .then(
            function(d) {
    ...
    function createSubscription(subscription){
    	...
    	SubscriptionPageService.createSubscription(subscription)
            .then(
            fetchAllSubscription,
            function(errResponse){
            }
    ...
    function deleteSubscription(id){
    	...
    	SubscriptionPageService.deleteSubscription(id)
            .then(
            fetchAllSubscription,
            function(errResponse){
    ...
    function updateSubscription(subscription, id){
    	...
    	SubscriptionPageService.updateSubscription(subscription, id)
            .then(
            fetchAllSubscription,
            function(errResponse){
            }
    ...
    function remove(id){
        ...
        if(main.subscription.id === id) {//clean form if the user to be deleted is shown there.
